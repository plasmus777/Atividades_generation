        ...
        <form className="flex justify-center items-center flex-col w-1/2 gap-4" onSubmit={login}>
          ...
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              name="usuario"
              placeholder="Usuario"
              className="border-2 border-green-900 rounded p-2"
          ...
          <button  type='submit' className="rounded bg-lime-500 hover:bg-lime-900 text-white w-1/2 py-2 flex justify-center">
