    ...
    <div className="container flex flex-col mx-auto items-center">
      ...
      <form onSubmit={gerarNovaPostagem} className="flex flex-col w-1/2 gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <select name="tema" id="tema" className='border p-2 border-green-800 rounded' onChange={(e) => buscarTemaPorId(e.currentTarget.value)}>
        ...
        <button disabled={carregandoTema} type='submit' className='rounded disabled:bg-green-200 bg-green-400 hover:bg-green-800 text-white font-bold w-1/2 mx-auto block py-2'>
